...
const services = [
  {
    id: '1',
    type: 'Beginner Driving Lesson (1-on-1)',
    price: '₹900',
    time: '1 hr',
    description: 'One-on-one driving lesson for beginners, covering basic driving skills, road safety, and car control.',
    imageUrl: 'https://example.com/driving1.jpg', // Replace with an appropriate driving-related image URL
  },
  {
    id: '2',
    type: 'Advanced Driving Techniques',
    price: '₹1200',
    time: '1.5 hrs',
    description: 'Advanced driving class for experienced drivers focusing on highway driving, parking, and safety maneuvers.',
    imageUrl: 'https://example.com/driving2.jpg', // Replace with an appropriate driving-related image URL
  },
  {
    id: '3',
    ...
    price: '₹900',
    time: '2 hrs',
    description: 'Learn defensive driving techniques to stay safe on the road, anticipate hazards, and avoid accidents.',
    imageUrl: 'https://example.com/driving3.jpg', // Replace with an appropriate driving-related image URL
  },
  {
    id: '4',
    ...
    price: '₹300',
    time: '45 mins',
    description: 'Simulate a real driving test experience to prepare for your official driving license test.',
    imageUrl: 'https://example.com/driving4.jpg', // Replace with an appropriate driving-related image URL
  },
];


const DrivingTeacherScreen = () => {
...
export default DrivingTeacherScreen;
